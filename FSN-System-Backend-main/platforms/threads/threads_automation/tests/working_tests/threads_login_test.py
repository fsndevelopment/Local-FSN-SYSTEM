...
class ThreadsLoginTest:
    ...
    def setup_driver(self):
        ...
        try:
            ...
            # Use the appium service to get driver
            device_udid = "ae6f609c40f74faeadc5a83c8c96bf8c6d0b3ccf"  # Your real device
            
            # Discover devices first
            appium_service.discover_devices()
            
            # Create session without app bundle (desktop launch)
            self.driver = appium_service.create_session(device_udid, None)
    ...
    def run_checkpoint_sequence(self, checkpoints):
        """Run the checkpoint sequence"""
        success = True
        for checkpoint_func, checkpoint_name in checkpoints:
            try:
                self.logger.info(f"🔍 Running checkpoint: {checkpoint_name}")
                result = checkpoint_func(self.driver)
                if not result:
                ...
                self.logger.error(f"❌ Checkpoint error in {checkpoint_name}: {e}")
                success = False
                break
        return success
    ...
    def checkpoint_3_enter_username(self, driver) -> bool:
        ...
        try:
            ...
            test_username = "nikita64712025c"  # Your test username
    ...
    def checkpoint_4_enter_password(self, driver) -> bool:
        ...
        try:
            ...
            test_password = "datNe4zRS5qy"  # Your test password
    ...
    def run_login_test(self):
        ...
        try:
            ...
            success = self.run_checkpoint_sequence(checkpoints)
