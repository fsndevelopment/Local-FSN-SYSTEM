...
export function GlobalSearchBar({ 
  ...
  return (
    <div className={`relative ${className}`} ref={containerRef} style={{ position: 'relative', zIndex: 40 }}>
      {/* Search Input */}
      ...
      {isOpen && (
        <div 
          ref={resultsRef}
          className="fixed bg-white border border-gray-200 rounded-2xl shadow-2xl z-40 max-h-96 overflow-y-auto min-w-96"
          style={{
