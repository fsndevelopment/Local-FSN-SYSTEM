...
export default function TrackingPage() {
  ...
  if (summaryLoading || accountsLoading) {
    return (
      <LicenseBlocker action="access tracking data">
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <h1 className="text-4xl font-bold text-white tracking-tight">Performance Tracking</h1>
                        <p className="text-gray-300 text-lg mt-1">Monitor your social media growth and automation performance</p>
                      </div>
                    </div>
                ...
                <div className="mt-8">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex-1 max-w-md">
                      <div className="animate-pulse h-10 bg-white/20 rounded-lg"></div>
                    </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-8">
              <div className="flex items-center justify-between">
                {/* Search */}
                <div className="flex-1 max-w-md">
                  <GlobalSearchBar placeholder="Search tracking data..." />
                </div>
  ...
  return <LicenseBlocker action="access tracking data">{children}</LicenseBlocker>
}