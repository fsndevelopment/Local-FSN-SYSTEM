...
export default function RunningPage() {
            ...
            if (latestJob.device_id === 4 || latestJob.device_id === "4") {
              ...
              setDeviceProgress(prev => {
                const newState = {
                  ...
                  "4": {
                    progress: latestJob.progress || 0,
                    currentAction: latestJob.current_step || latestJob.message || 'Processing...',
  ...
  useEffect(() => {
    ...
    if (message.type === 'job_update' && message.data) {
      ...
      // ALWAYS use device ID 4 since that's your iPhone
      const targetDeviceId = "4"
      
      console.log('📊 UPDATING DEVICE 4 PROGRESS:', {
        ...
        <div className="space-y-6">
          {isLoading ? (
            ...
            <div className="text-center py-20">
              ...
              <Button className="bg-black text-white hover:bg-gray-800 rounded-2xl px-8 py-3 font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
